package com.meetingmind.service.segmentation;
...
import com.meetingmind.service.ModelProvider;
...
public class SegmentOptimizationService {
    ...
    public void endSession(String sessionId) {
        ...
        // 更新会话状态
        sessionService.updateSessionState(sessionId,
                com.meetingmind.entity.SessionContext.SessionState.ENDED);
    ...
    public void processAudioSegment(AudioSegment segment) {
        ...
        // 更新会话状态
        sessionService.updateSessionState(sessionId, 
                com.meetingmind.entity.SessionContext.SessionState.PROCESSING);
    ...
    private String buildOptimizationContext(
            com.meetingmind.entity.SessionContext context) {
        if (context == null) {
            return null;
        }
     ...
     * 获取会话状态
     */
    public com.meetingmind.entity.SessionContext getSessionStatus(String sessionId) {
